  ...
  <>
    <div className="Page-content">
      ...
      <p>
        ...
        complete the labs, think about potential ways you could apply each tool.{" "}
        <font color="#F03F47">
      ...
      <p>
        ...
        <a href="https://reactjs.org/tutorial/tutorial.html">React</a>, which is
        currently the most{" "}
        <a href="https://www.npmtrends.com/@angular/core-vs-angular-vs-react-vs-vue-vs-svelte-vs-flutter">
          popular
        </a>{" "}
        front-end web development software. Despite being the most widely used,
        ...
        <a href="https://htmlcheatsheet.com/css/">CSS</a> code. Hypertext Markup
        Language (HTML) is the oldest out of the three and is primarily used to
        define the layout of webpages. Cascading style sheets (CSS) was
        introduced second and enables developers to style their HTML elements
        (e.g. font style or coloring). To incorporate coding logic (e.g. if,
        for, and while statements), Javascript was introduced. It's an easy
        language to learn and can be included in any HTML file by bounding the
        Javascript code with a{" "}
        <a href="https://www.w3schools.com/tags/tag_script.asp">{"<script>"}</a>{" "}
        ...
        ), which certain languages require to be specified (e.g. Python might be
        thrown off if you try to use a floating point number to specify an array
        index - myarray[5.0] will result in an error). React's framework
        ...
        ) that enables developers to write HTML style code in Javascript files.
        React's emulated HTML code enables makes it easy to fuse HTML elements
        with Javascript logic and is referred to as{" "}
      ...
      <p>
        ...
        <a href="https://www.youtube.com/watch?v=w3jLJU7DT5E">GitHub</a>. GitHub
        is a powerful resource to store your project code and maintain a
        detailed history of every modification you've ever made to your project.
        You don't have to worry about losing your previous work if your hard
        drive crashes and you can demonstrate the contributions you've made to
        your project if you ever have to prove ownership of your work.{" "}
        <font color="orange">
        ...
        Add will send any modified files (relative to your public repository) to
        a local staging area. You can specify individual files (e.g. "git add
        MyNewFile.py") or use the "-A" option to add all new or modified files
        to the staging area. Commit will take a snapshot of the currently staged
        changes and helps maintain a clear history of how your work evolved. You
        should include a message when you run commit your code since you can
        refer to that message later if you need to find something that was
        removed at some point when developing your project. Always try to use
        detailed commit messages since you can use them in the future to find
        something located in a previous version of your repository. You should
        use "
        ...
        repository. Run "<code>git status</code>" first since it will help when
        writing your commit messages. Finally, "git push" will push your
        ...
        you have a "<code>.gitignore</code>" file (which you will), any files or
        folders listed in the file will not be sent to the public repository.
        Syncing repositories can take a long time so excluding certain folders
        or files can reduce the time required to sync your repositories. It's
        also a useful way to include private code (e.g. passwords) in your local
        repository that you don't want anyone else to see. In summary, run: (1)
        "git status" (2) "git add -A", (3) "git commit -m "I updated thing C and
        added thing D", (4) "push").
      </p>
      <p>
        ...
        can use the IDE for up to 100 hours a month. User sessions in GitPod run
        as remote{" "}
        ...
        <font color="orange">
          ...
          pattern. GitPod containers are temporary and are deleted automatically
          by GitPod after 14 days of inactivity. You can check your workspaces
          by clicking the icon located at the top right corner of your GitPod
          environment, then selecting "Open Workspaces" from the dropdown menu
          that appears. All of the workspaces you've opened will be listed. The
          running workspaces will have a vertical green bar to the left. If you
          have multiple workspaces with green vertical bars listed, both are
          consuming your monthly quota.{" "}
        </font>{" "}
        Workspaces that are currently shutting down will have a yellow vertical
        bar. Inactive workspaces won't have a colored bar and aren't counting
        against your quota. Every workspace becomes inactive after 30 minutes of
        inactivity, but it's best to close your workspace (after pushing your
        updates to GitHub) so that it won't consume your monthly usage.
      </p>
      <p>
        ...
        <a href="https://en.wikipedia.org/wiki/URL">URL</a>. Node.js provides a
        ...
        file. Every Node.js project has a <code>package.json</code> file so it's
        wise to check that file first whenever you explore a new project. In
        addition to listing the installed libraries for a project,{" "}
        <code>package.json</code> files also list executable commands and a
        variety of other potential project specifications. You can even add your
        own executable commands to your project's <code>package.json</code>{" "}
        file. After running "npm install" in the same directory as a{" "}
        <code>package.json</code> file, the Node.js libraries will be installed
        in a{" "}
      ...
      <p>
        ...
        <code>node_modules</code> folder in addition to other files that GitHub
        should ignore. Forcing git to track every file in every installed
        project library would make updating your GitHub repository (e.g. the
        add/commit/push pattern) take a very long time. Therefore, it's common
        practice to ignore these files in your public repository and to run "npm
        install" in the same directory as the <code>package.json</code> whenever
        you are opening your project in a new workspace. package.json file. You
        will need to run "cd" into your app directory and then run "npm install"
        to re-download the Node.js packages that were installed when you ran
        "npx create-react-app myapp." You want the "node_modules" to be included
        in your ".gitignore" file because it will take git a long time to sync
        your changes if it has to go through every single library that you're
        using. The "package.json" file is so helpful since it tells node.js what
        packages to look for when cloning a repository.{" "}
        <font color="orange">
          ...
          <code>package.json</code> file to reinstall the necessary packages. If
          you return to a GitPod workspace that you were previously working on,
          you should already have the <code>node_modules</code> folder. If so,
          reinstallation isn't necessary. When working with GitPod, you should
          check your GitPod workspace list frequently to ensure you don't have
      ...
      <p>
        ...
        will tell you to use <a href="https://www.npmjs.com/package/npx">npx</a>{" "}
        when first creating your app instead of npm. Using npx is helpful
        because it temporarily downloads the required{" "}
        ...
        create-react-app). Installing the package globally will make enable npm
        to understand the "create-react-app" command. However, installing the
        library globally might become problematic if you don't keep it up to
        date. Using npx will ensure that you are referring to the up to date
        version of the library when creating your app, and you won't need to
        install the app globally. When you change into your newly created app's
        directory, (e.g.{" "}
      ...
      <ul>
        ...
        <li>
          Make a <a href="https://www.gitpod.io/">GitPod</a> account and connect
          it to your GitHub account. Feel free to use another IDE such as{" "}
          <a href="https://code.visualstudio.com/">VS Code</a> if you have a
          preference. VS Code is a more robust long-term solution because it
        ...
        <li>
          ...
          repository. Use that button to open the IDE within your newly created
          project. If using a different IDE, you can clone the repository to
          ...
          .{" "}
          <font color="orange">
            Every time you press the GitPod button, a new GitPod workspace will
            be created even if you have already opened the same repository in
            GitPod previously. You can either reinstall the Node.js libraries or
            list your workspaces in GitPod and return to the correct workspace
            from there.{" "}
          </font>
        </li>
      </ul>
      ...
      <ul>
        <li>
          ...
          your app. (i.e. <a href="https://nodejs.org/en/">Node.js</a>) Use the
          IDE terminal to create your app as described in React's{" "}
          <a href="https://reactjs.org/docs/create-a-new-react-app.html">
            documentation
          </a>
          . You only need to follow the instructions under "Create React App."
          The second step under that section uses "cd" which stands for "change
          directory." Knowing how to work with terminals using{" "}
          <a href="https://devhints.io/bash">Bash</a> can be very helpful when
          working with{" "}
          <a href="https://www.edureka.co/blog/iot-tutorial/">IoT</a> tools.
        </li>
        <li>
          After running the start command, your terminal will display a URL that
          you can follow to display your running app! The app is set up to
          continuously reload so you'll be able to see the result of any changes
          you make whenever you save an opened file.
        </li>
        <li>
          Explore your project's file structure and the newly created{" "}
          <code>package.json</code> file. Your project's main source code can be
          found in the <code>src</code> folder. In that folder you'll find a
          series of Javascript and CSS files. There aren't any HTML files in
          ...
          <font color="red">
            ...
            of the{" "}
            <a href="https://www.w3schools.com/html/html_id.asp">id variable</a>{" "}
        ...
        <li>
          ...
          "ctrl-shift-c" (command-shift-c on mac) to open up the Elements panel
          in{" "}
          <a href="https://developers.google.com/web/tools/chrome-devtools">
            Chrome DevTools
          </a>
          . If your app is running in GitPod's preview mode, DevTools will also
          display html code that is related to GitPod's IDE. To prevent this,
          you can click the "Open Ports" tab at the top of your terminal and
          select the "Open Browser" option located on the right side of port
          3000. The Elements panel contains your compiled html code, which will
          update whenever you modify and save any of your project files. As
          mentioned previously, this is referred to as{" "}
          <a href="https://hashnode.com/post/what-is-hot-reloading-exactly-is-it-just-another-fancy-term-for-live-reloading-cirvu9avg0c8mmk53b5zxr3ga">
            hot reloading
          </a>{" "}
          is very helpful when developing your software. The top left corner of
          the DevTools panel contains an image of a mouse hovering over a box.
          Make sure that button is highlighted then hover over specific elements
          of your app.
        </li>
        <li>
          You can also hover over the rows in the DevTools Elements pane. Items
          in the html page will also flash when hovering over the corresponding
          html element code!
        </li>{" "}
        <li>
          On the left side of the html code there are triangles that you can
          click to collapse ore reveal subsections of your app. Reveal the each
          section so that you can hover your mouse over the image tag{" "}
        ...
        <li>
          ...
          folder that contains a static version of your app that is ready to be
          hosted publicly! If your app is currently running in development mode,
          you need to kill the process by typing "ctrl-c" in your terminal. This{" "}
      ...
      <ul>
        ...
        <li>
          Verify that you have pushed your changes to your public repository by
          ...
          and the time looks correct, then use the button located directly above
          that text to download or "git clone your-app-repo-url" your app to
          your local machine.
        </li>
        <li>
          To host your app, this tutorial will use{" "}
          <a href="https://www.netlify.com/">Netlify</a>'s free hosting service.
          Feel free to use whatever hosting service you'd like. Netlify makes it
          easy to host websites for free and offers a generous monthly memory
          bandwidth. After you create your Netlify profile, you'll eventually
          reach a new site page that contains an option to drag and drop your
          site into a grey dashed box. Grab the{" "}
